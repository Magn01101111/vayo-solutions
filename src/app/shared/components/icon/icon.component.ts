...
/**
 * SVG icon component (Heroicons outline, MIT).
 * Usage: <app-icon name="eye" [size]="20" />
 * Available: eye | eye-off | close | check | box | dots-h | user | cart
 *          | money | receipt | document | users | folder | check-circle | mail | download
 */
@Component({
  selector: 'app-icon',
  standalone: true,
  template: `
    ...
    >
      @switch (name()) {
        ...
        @case ('dots-h') {
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M6.75 12a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0ZM12.75 12a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0ZM18.75 12a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" />
        }
        @case ('user') {
        ...
        @case ('receipt') {
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 14.25h6m-6 3h6m2.25-12v15.75a.75.75 0 0 1-1.125.65L15 21l-2.25 1.35L10.5 21l-2.25 1.35L6 21l-1.125.65A.75.75 0 0 1 3.75 21V5.25m13.5 0V3.75a.75.75 0 0 0-.75-.75H4.5a.75.75 0 0 0-.75.75v1.5m13.5 0H3.75M9 8.25h6" />
        }
        @case ('document') {
...
export class IconComponent {
  name = input.required<
    | 'eye' | 'eye-off' | 'close' | 'check' | 'box' | 'dots-h' | 'user' | 'cart'
    | 'money' | 'receipt' | 'document' | 'users' | 'folder' | 'check-circle' | 'mail' | 'download'
  >();
